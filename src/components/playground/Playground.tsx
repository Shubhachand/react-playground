            ...
            <div className="p-2 bg-[#21222C] border-b border-gray-700 flex justify-start">
              <div className="flex items-center bg-gray-900 rounded-lg p-1">
                <button
                  ...
                  className="px-3 py-1 text-sm font-medium rounded-md text-gray-400 hover:bg-gray-700"
                >
                  Code
                </button>
                <button
                  onClick={() => setMainView('preview')}
                  className="px-3 py-1 text-sm font-medium rounded-md bg-blue-600 text-white shadow"
                >
                  Preview
                </button>
              </div>
            </div>
            <PreviewFrame initialJsx={session.jsxCode} initialCss={session.cssCode} />
          </div>
        )}
      </div>
